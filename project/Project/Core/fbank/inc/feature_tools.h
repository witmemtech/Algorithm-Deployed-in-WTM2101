...
#define _UPDATE_SIZE     400
#define _UPDATE_SHORT_SIZE     800//_UPDATE_SIZE*2
#define _NUM_MEL_BINS  40
#define FFT_SUB_WINDOW_INT_LEN 448  //(_NFFT-_WIN_SIZE)*4
#define SUB_WINDOW0          0   //_WIN_SIZE - _UPDATE_SIZE
#define SUB_WINDOW0_INT_SIZE       0   //SUB_WINDOW0*4
#define SUB_WINDOW0_SHORT_SIZE     0   //SUB_WINDOW0*2
