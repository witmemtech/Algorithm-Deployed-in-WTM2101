...
typedef enum{
  ...
  HAL_I2S_CHANNEL_SET_TIMER_TIMEOUTS_MS = (1 << 2),              /*the hal i2s set timeout*/
  HAL_I2S_CHANNEL_START_TIMER = (1 << 3),                        /*the hal i2s start timeout*/
  HAL_I2S_CHANNEL_GET_TIMER_TIMEOUS_MS_FLAG = (1 << 4),          /*the hal i2s get timer timeout_ms flag*/
  HAL_I2S_CHANNEL_SET_TIMER_TIMEOUS_MS_FLAG = (1 << 5),          /*the hal i2s set timer timeout_ms flag*/
...
typedef struct Hal_I2s_InitTypeDef{
  ...
  int timer_timeout_ms_flag;                      /*the timer timeout_ms flag*/
}Hal_I2s_InitTypeDef;
