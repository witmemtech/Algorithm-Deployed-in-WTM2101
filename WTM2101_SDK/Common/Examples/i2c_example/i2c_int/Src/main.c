/**
  ******************************************************************************
  * @file    main.c
  * @brief   This example describes how to use the I2C interrupt to
  *          detect status of I2C transfer.
  * @date    2023-02-07
...
void main(void)
{
    ...
    ECLIC_SetPriorityIRQ(I2C_IRQn, 1);
    ECLIC_SetTrigIRQ(I2C_IRQn, ECLIC_POSTIVE_EDGE_TRIGGER);
    ECLIC_EnableIRQ(I2C_IRQn);
    ...
    SHT20_init();
    I2C_IT_MskCtl(I2C, I2C_IT_ALL, ENABLE);
    I2C_IT_MskCtl(I2C, I2C_IT_STOP_DET, DISABLE);
