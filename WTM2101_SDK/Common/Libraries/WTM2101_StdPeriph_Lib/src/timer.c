...
uint32_t TIMER_Transfer_second_to_tick(TMR_TypeDef* TIMERx, float second)
{
...
uint32_t TIMER_Transfer_millisecond_to_tick(TMR_TypeDef* TIMERx, float millisecond)
{
    uint32_t timer_div = 0;
...
uint32_t TIMER_Transfer_microsecond_to_tick(TMR_TypeDef* TIMERx, float microsecond)
{
    uint32_t timer_div = 0;
