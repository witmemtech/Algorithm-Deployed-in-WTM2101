...
//
//  uartxfer
//      msgid::file_data,  mono or stereo
//      msgid::file_data2, unused
//
//  jtagxfer
//      msgid::file_data,  mono
//      msgid::file_data2, stereo
//
...
#include "datalink_msg_debug.h"         // msgid=8
#include "datalink_msg_file_dataex.h"   // msgid=9
#include "datalink_msg_jtag_report.h"   // msgid=10
#include "datalink_msg_file_data2.h"    // msgid=11
#include "datalink_msg_file_eof.h"      // msgid=12
#include "datalink_msg_spectrum_mask.h" // msgid=13
#include "datalink_msg_command.h"       // msgid=14
#include "datalink_msg_status.h"        // msgid=15
...
int datalink_is_valid_message(
        const datalink_message_t* msg);

void datalink_print_message(
        const datalink_message_t* msg);
