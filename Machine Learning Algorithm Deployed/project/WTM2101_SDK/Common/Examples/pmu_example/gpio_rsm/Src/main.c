...
{
    GPIO_IT_ClrWakeUpPending(GPIOA, GPIO_PIN_15);
    GPIO_IT_ClrPending(GPIOA, GPIO_PIN_15);
}
...
void gpio_config(void)
{
    ...
    GPIO_InitStructure.Alternate = GPIO_AF15_GPIO;
