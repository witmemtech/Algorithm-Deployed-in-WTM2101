...
*/
extern uint32_t TIMER_Transfer_second_to_tick(TMR_TypeDef* TIMERx, uint32_t second);
...
* @retval tick of TIMER
*/
extern uint32_t TIMER_Transfer_millisecond_to_tick(TMR_TypeDef* TIMERx, uint32_t millisecond);
...
* @retval tick of TIMER
*/
extern uint32_t TIMER_Transfer_microsecond_to_tick(TMR_TypeDef* TIMERx, uint32_t microsecond);
