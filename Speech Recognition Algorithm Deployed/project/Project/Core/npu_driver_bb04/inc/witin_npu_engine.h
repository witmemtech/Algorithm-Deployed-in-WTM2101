...
// use when change MCU clock or NPU clock
int wengine_change_npu_clock();
...
//get cnn buffer and len
int wengine_get_dma_buffer(char **buffer, int *len);
int wengine_set_dma_buffer(char *buffer, int len);
#endif
