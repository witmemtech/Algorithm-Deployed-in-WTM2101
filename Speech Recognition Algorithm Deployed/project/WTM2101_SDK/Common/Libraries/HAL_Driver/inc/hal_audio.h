...
typedef enum {
  HAL_AUDIO_CHANNEL_WIDTH_12BITS = 0,              /*using pcm 12bits,the developer must enable system HAL_CLOCK_320KOSC osc*/  
...
typedef struct{
  ...
  Audio_Channel_Width_TypeDef     ChannelWidth;                    /*the data width of audio channel,the HAL_AUDIO_CHANNEL_WIDTH_12BITS only use in the HAL_AUDIO_CHANNEL0_NUMBER 
                                                                     the developer must enable system HAL_CLOCK_320KOSC osc.
                                                                     the value AGC_Enable must be set DISABLE about wtm2101*/
