...
uint32_t AUDIO_Get_Channel_Gain_Configuration(AUD_TypeDef *audio, uint8_t channel)
{
    assert_param(audio != NULL);
    assert_param(IS_AUD_ALL_INSTANCE(audio));
    assert_param(IS_AUDIO_CHANNEL(channel));
...
void AUDIO_Set_Channel_Gain_Configuration(AUD_TypeDef *audio, uint8_t channel, uint8_t value)
{
